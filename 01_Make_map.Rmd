...
mapview(df_comb1, zcol = "Stasjon", col.regions = cols, alpha.regions = 1, cex = 3) %>%
...
# With smaller dots, for showng all or Norway
mapview(df_comb2, zcol = "Stasjon", col.regions = cols, alpha.regions = 1, cex = 3) %>%
...
# With smaller dots, for showng all or Norway
mapview(df_comb3, zcol = "Stasjon", col.regions = cols, alpha.regions = 1, cex = 3) %>%
